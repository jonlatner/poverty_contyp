...
with(df_eu_silc,table(country,male))

with(df_eu_silc,table(male))
...
ggsave(plot = p, filename = paste0(graphs,"graph_sensitivity_micro_macro_int_male.pdf"), height = 9, width = 10.5)
