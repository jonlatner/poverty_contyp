...
df_eu_silc <- readRDS(paste0(data_files,"03_df_eu_silc_trt_sample_clean_poverty_line_anchor.rds"))
...
saveRDS(df_output, file = paste0(results, "results_c_micro_macro_int_poverty_line.rds"))
...
ggsave(plot = p, filename = paste0(graphs,"graph_sensitivity_micro_macro_int_anchor_poverty_line.pdf"), height = 9, width = 10.5)
